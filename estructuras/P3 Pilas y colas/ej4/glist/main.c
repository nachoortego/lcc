...
int main() {
  ...
  contactos[6] = contacto_crear("Nombre Prueba", "3416894557", 50);
  ...
  printf("El resultado es %d", sglist_buscar(listaOrdenada,(void**) contactos[6], (FuncionComparadora)compara_edad));
